...
### ==[69. x 的平方根 ](https://leetcode-cn.com/problems/sqrtx/)==   ==111==
...
采用了一种双指针，并未采用hashmap

#### [18. 四数之和](https://leetcode-cn.com/problems/4sum/)

###### 1

与上述题其实是一个套路，但是没做对。更深化了一些
...
#### [剑指 Offer II 094. 最少回文分割](https://leetcode.cn/problems/omKAoA/)    ==11==
...
#### [491. 递增子序列](https://leetcode-cn.com/problems/increasing-subsequences/)     ==111==
...
#### [376. 摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence/)  ==11==
...
#### [45. 跳跃游戏 II](https://leetcode-cn.com/problems/jump-game-ii/) ==11111==
...
#### [135. 分发糖果 ](https://leetcode-cn.com/problems/candy/)  ==111==
...
#### [738. 单调递增的数字](https://leetcode-cn.com/problems/monotone-increasing-digits/)  ==111==
...
#### [494. 目标和](https://leetcode-cn.com/problems/target-sum/)    ==111111==
...
#### [496. 下一个更大元素 I ](https://leetcode-cn.com/problems/next-greater-element-i/)  ==11==
...
#### [剑指 Offer II 076. 数组中的第 k 大的数字 ](https://leetcode.cn/problems/xx4gT2/)      ==1==  
...
#### [剑指 Offer II 014. 字符串中的变位词   ==1==](https://leetcode-cn.com/problems/MPnaiL/)

变位题不止一道，但是变位题套路一样。首先获取不同的个数diff.建立数组进行对比。不要使用map这些。

#### [剑指 Offer II 029. 排序的循环链表   ==1==](https://leetcode-cn.com/problems/4ueAj6/)
...
#### [剑指 Offer II 051. 节点之和最大的路径   ==1==](https://leetcode.cn/problems/jC7MId/)



#### [剑指 Offer II 057. 值和下标之差都在给定的范围内   ==1==](https://leetcode.cn/problems/7WqeDu/)
...
#### [剑指 Offer II 073. 狒狒吃香蕉](https://leetcode.cn/problems/nZZqjQ/)  ==1==
