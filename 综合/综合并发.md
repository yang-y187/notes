...
- **acquire( ):源码和3大流程走向**
  ...
  ![在这里插入图片描述](data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1326 538"%3E%3C/svg%3E)
...
![在这里插入图片描述](data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1305 671"%3E%3C/svg%3E)
